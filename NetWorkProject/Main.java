...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("¿ªÇÒÀ» ¼±ÅÃÇØ ÁÖ¼¼¿ä.");
		System.out.println("1.¼­¹ö");
		System.out.println("2.Å¬¶óÀÌ¾ðÆ®");
		System.out.println("3.Á¾·á");
		String sel = sc.nextLine();
			switch(sel) {
			case "1" : 
				myServer ms = new myServer(); //¼­¹ö °´Ã¼ »ý¼º.
				ms.main();//½ÇÇà.
				break;

			case "2" : 
				myClient c = new myClient(); // Å¬¶óÀÌ¾ðÆ® °´Ã¼ »ý¼º.
				c.main();	
				break;
			...
			default : System.out.println("only 1 or 2, 3!"); // 1, 2, 3 ÀÌ¿ÜÀÇ °ª ÀÔ·Â ½Ã
			}
